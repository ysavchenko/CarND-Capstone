...
class DBWNode(object):
    def __init__(self):
        ...
        self.controller.init_yaw(wheel_base, steer_ratio, 0.1, max_lat_accel, max_steer_angle)
        self.controller.init_throttle(.3, .1, .0, .0, .2)
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.current_linear_velocity is not None and self.target_linear_velocity is not None and self.target_angular_velocity is not None:
